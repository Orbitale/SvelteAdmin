<script lang="ts">
	...
	import TopLeftMenu from '$lib/admin/Menu/TopLeftMenu.svelte';
	import TopRightMenu from '$lib/admin/Menu/TopRightMenu.svelte';
	import type { MenuLink } from '$lib/admin/Menu/MenuLinks.js';
	import { type AdminConfig, emptyAdminConfig } from '$lib/admin/config/adminConfig.js';
